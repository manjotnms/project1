...
public class HIDManager
{
     ...
     * @throws IOException
     */
    public HIDManager() throws IOException
    {
        init();
    }
    ...
    {
    	HIDDevice deviceSelected = null; 
        HIDDeviceInfo[] devs = listDevices();
        for(HIDDeviceInfo d : devs)
        {
        	System.out.println(d.getVendor_id()+","+d.getProduct_id());
        	if(d.getManufacturer_string().equals("RFID_HID") && d.getProduct_string().equals("By:Vanch")) {
            /*if(d.getVendor_id() == vendor_id && d.getProduct_id() == product_id
                    && (serial_number == null || d.getSerial_number().equals(serial_number))){ */	
        		System.out.println("andar a gea...");
            	System.out.println(d.toString());
            	//System.out.println(d.getVendor_id()+","+d.getProduct_id()+","+d.getInterface_number());
            	//System.out.println(d.);
            	if ( (deviceSelected = d.open()) != null ) {
            		System.out.println("Device milgea...");
            		return deviceSelected;
            	} else {
            		System.out.println("Device NAHI MILEA...");
            		return null;
            	}
            }
        }
        System.out.println("size :"+devs.length);
        throw new HIDDeviceNotFoundException(); 
    }
