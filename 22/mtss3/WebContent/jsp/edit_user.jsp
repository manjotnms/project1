                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  New User ? Register Yourself </strong>  
                            ...
                            <div class="panel-body">
                                <form:form action="changePassword.spr" method="post" modelattribute="user" id="editUser">
<br/>
										<div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                            <input type="text" class="form-control" placeholder="Username" id="userName" name="userName" value="${currentUname.userName}" readonly="readonly"/>
                                        </div>
                                        <div class="form-group input-group">
                                     ...
                                     <a href="#" class="btn btn-success " id="editUserInfo">Edit User</a>
                                    <hr />
