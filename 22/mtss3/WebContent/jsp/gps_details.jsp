                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                     <c:forEach items="${gpsList}" var="gps">
                                        <tr class="odd gradeX">
                                            <td>${gps.IMEI}</td>
                                            <td>${gps.dateOfIssue}</td>
                                            <td class="center">${gps.avail}</td>
                                            <td class="center">${gps.inUse}</td>
                                            <td class="center"><a href="deleteGPS.spr?gpsNo=${gps.IMEI}" class="change_status">Delete</a></td>
                                        </tr>
                                     </c:forEach> 
                                    </tbody>
                                </table>
