...
<script type="text/javascript">
 	$(document).ready(function() {
     	...
     	$('a.change_status_edit').click(function(event) {
            var url = $(this).attr('href');
            //alert("Remove User "+url);
            if (confirm("Do You Want To Edit User Record......?")) {
            	$(location).attr('href',url);
            }
            return false;
     	});
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${userList}" var="user">
                                        <tr class="odd gradeX">
                                            <td>${user.userName}</td>
                                            <td>${user.userType}</td>
                                            <td class="center"><a href="editUser.spr?userName=${user.userName}" class="change_status_edit">Edit</a></td>
                                            <td class="center"><a href="removeUser.spr?userName=${user.userName}" class="change_status">Delete</a></td>
                                        </tr>
                                     </c:forEach>
                                    </tbody>
                                </table>
