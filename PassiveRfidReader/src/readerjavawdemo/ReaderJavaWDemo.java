...
/**
  * @author å¾�è¾›æ³¢(sinpo.xu@hotmail.com) Oct 19, 2008
  */
 public class ReaderJavaWDemo extends Thread {
 	public void run() {
 		//TestOri();//æµ‹è¯•åŽŸå§‹çš„
 				...
 				if (eventsCount > 0) {
 					...
 					while (iterator.hasNext()) {
 						...
 						if (sk.isReadable()) {
 							...
 							// æµ‹è¯•ï¼šé€šè¿‡å°†æ”¶åˆ°çš„ByteBufferé¦–å…ˆé€šè¿‡ç¼ºçœ�çš„ç¼–ç �è§£ç �æˆ�CharBuffer å†�è¾“å‡ºé©¬å‚¨æ²¹å¹³å�°
 							...
 							//String echo = "This is the reply message from æœ�åŠ¡å™¨ã€‚";
