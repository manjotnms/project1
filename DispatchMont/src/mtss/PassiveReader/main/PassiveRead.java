...
public class PassiveRead extends Thread {
	...
	static Logger log = Logger.getLogger(PassiveRead.class.getName());
...
*/
	...
	public boolean connectReader() {
        ...
        try {
    	    ...
    	    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("mtss.PassiveReader.main/PassiveReaderConfig");
...
*/
	...
	public boolean disConnectReader() {
		System.out.println("disconnect reader called...");
